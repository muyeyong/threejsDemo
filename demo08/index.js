...
new RGBELoader().loadAsync('textures/hdr/004.hdr').then( texture => {
    console.log('233', texture)
    // texture.mapping = THREE.EquirectangularRefractionMapping // TODO 这两种映射模式有什么区别
    texture.mapping = THREE.EquirectangularReflectionMapping
    scene.background = texture
})
// scene.background = eventMapTexture
